...
#   - DNS _lexicon.dataset.foundation.ac TXT record pointing to the publishing DID
#
# Usage:
#   ./scripts/publish.sh
...
LEXICON_DIR="$(cd "$(dirname "$0")/../lexicons/ac/foundation/dataset" && pwd)"
...
for lexicon_file in "$LEXICON_DIR"/*.json; do
    ...
    full_nsid="ac.foundation.dataset.$nsid"
